/*
  ...
  - You are about to drop the `Deliverys` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "Deliverys" DROP CONSTRAINT "Deliverys_id_client_fkey";

-- DropForeignKey
ALTER TABLE "Deliverys" DROP CONSTRAINT "Deliverys_id_deliveryman_fkey";
